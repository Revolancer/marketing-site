        ...
        <Flex column gap={4}>
          ...
          <FAQItem label="Why would freelancers want to trade instead of being paid money?">
            ...
            <P>
              ...
              ultimately leading to increased work opportunities and potentially
              more revenue in the long run.
            </P>
          </FAQItem>
          <FAQItem label="How would you value what services are worth?">
            <P>
              In a regular barter trade it might be a bit difficult to estimate
              the value of traded services, but Revolancer makes it easy! During
              onboarding we ask all independents about their users of experience
              and hourly rate. This data is then used to help independents price
              their services in credits (our algorithm will let you know if its
              likely you&rsquo;re over or undercharging your services).
            </P>
          </FAQItem>
          ...
          <FAQItem label="What are Credits?">
            ...
            <ul>
              <li>
                professional social media assets (e.g. profile picture editing,
                banners, logo, tagline)
              </li>
              <li>
          ...
          <FAQItem label="Do I need to swap both ways?">
            <P>
              ...
              credits can then be used to access a variety of services and grow
              your business without incurring significant costs.
            </P>
            <P>
