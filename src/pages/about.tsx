        ...
        <FullWidth>
          ...
          >
            <Flex column gap={8}>
              ...
              <P>
                Revolancer is a skill swapping platform for self-employed people
                to grow their small businesses without spending money. Earn
                credits by completing projects, and spend credits on services
                you need. Get the tools for your business: logos, financial
                advice, branding, marketing and more, to help you succeed in
            ...
            >
              <Flex column gap={8}>
                ...
                <P>
                  ...
                  Karl to a rather sad conclusion: its current form is rubbish,
                  and freelancers way too often go undervalued. This thought
                  made him want to rewrite the rules. And so, here we stand here
                  today 🫡.
                </P>
                <P>
          ...
          >
            <Flex column gap={8}>
              ...
              <P>
                ...
                co-founder, referring to us as a &ldquo;Cool startup.&rdquo; To
                be honest, we find that quite cool 😎.
              </P>
            </Flex>
